...
const styles = StyleSheet.create({
  ...
  voucherInput:        { flex: 1, height: 48, borderWidth: 1.5, borderRadius: 12, paddingHorizontal: 14, fontSize: 16, fontFamily: "Inter_500Medium", letterSpacing: 1 },
  voucherBtn:          { height: 48, paddingHorizontal: 18, borderRadius: 12, alignItems: "center", justifyContent: "center" },
